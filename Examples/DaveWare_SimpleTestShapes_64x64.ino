...
void drawText(int colorWheelOffset)
{
  ...
  dma_display->println();
  dma_display->setCursor(0,32);    // start at top left, with 8 pixel of spacing  
...
void drawDaveWare(int colorWheelOffset)
{
  ...
  dma_display->setCursor(20, 8);    // start at top left, with 8 pixel of spacing
  const char *str1 = "Design";
  for (w=0; w<strlen(str1); w++) {
    dma_display->setTextColor(colorWheel((w*32)+colorWheelOffset));
    dma_display->print(str1[w]);
  }
  ...
  dma_display->setCursor(15, 56);    // start at top left, with 8 pixel of spacing
  // print each letter with a fixed rainbow color
  dma_display->setTextColor(dma_display->color444(0,8,15));
  dma_display->print('6');
  dma_display->setTextColor(dma_display->color444(15,4,0));
